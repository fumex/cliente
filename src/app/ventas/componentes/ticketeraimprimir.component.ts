...
export class ImprimirVentasTicketeraComponent{
    ...
    ngOnInit(){
        ...
        if(this.ventas!=null){
            ...
            this.fecha=this._VentasService.recojerdatos('fecha');
        ...
        this.sumapago= this.ventas.pago_efectivo*1+this.ventas.pago_tarjeta*1;
    }
    getempresas(){
    ...
    imprimirElemento() {
        ...
        var ventana = window.open('', '_blanck', 'height=400,width=600');
        ventana.document.write('<html><head><title>' + document.title + '</title>');
        ventana.document.write('<link rel="stylesheet" href="//netdna.bootstrapcdn.com/bootstrap/3.1.0/css/bootstrap.min.css">');
        ventana.document.write('<link rel="stylesheet" href="src/assets/css/helper.css">');
        ventana.document.write('<link rel="stylesheet" href="src/assets/css/style.css">');
